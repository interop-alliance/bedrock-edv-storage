...
/**
 * @typedef {import('@interop/data-integrity-core').IEDVChunk} IEDVChunk
 */
 ...
 * @param {string} options.edvId - The ID of the EDV the document chunk is in.
 * @param {string} options.docId - The ID of the document the chunk is
 *   associated with.
 * @param {IEDVChunk} options.chunk - The encrypted chunk to store.
 ...
 * @param {string} options.docId - The ID of the document the chunk is
 *   associated with.
 * @param {number} options.chunkIndex - The index of the chunk to remove.
 * @param {boolean} [options.explain=false] - An optional explain boolean.
 *
 * @returns {Promise<boolean> | ExplainObject} Resolves with `true` if a
 *   document chunk was removed and `false` if not or an ExplainObject if
 *   `explain=true`.
 */
