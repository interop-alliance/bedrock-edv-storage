...
/**
 * Reports a single operation's usage against the EDV's meter. Usage is not
 * awaited; any reporting error is logged.
 *
 * @param {object} options - The options to use.
 * @param {object} options.req - The Express request, with `req.edv.config`
 *   populated.
 */
