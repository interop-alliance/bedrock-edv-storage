...
/**
 * Handles an EDV document query request. The request body corresponds to the
 * @interop/data-integrity-core IEDVQuery interface; either a `count` or a set
 * of matching documents (or document IDs) is returned.
 *
 * @param {object} req - The Express request; `req.body` holds the IEDVQuery.
 * @param {object} res - The Express response to write results to.
 *
